...
""" This poroelastic demo implements a draining unit square using the porous
...
The demo is implemented in the main python file 'demo_drain.py' and requires
...
# --------------
#
# This description goes through the implementation of 'demo_drain.py', which
# implements the drainage of a unit square using the fluid source term q
# by inverting the influx in the configuration file
# step-by-step.
#
...
#
# Moving back to the 'demo_drain' , we are using the dolfin provided 'split()'
